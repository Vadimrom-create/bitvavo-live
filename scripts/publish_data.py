...
GENERATED = ['bitvavo_live.json', 'live_quotes.json', 'ethfi_live.json', 'scan_feed.txt', 'early_watch.txt', 'early_watch.json', 'scan_history.json',
             ...
             'pipeline_health.json', 'trend_cache_guard.json', 'decision_funnel.json', 'data_quality_audit.json', 'data_quality_audit.md', 'adaptive_enrichment.json', 'evaluation.json', 'proposed_orders.json', 'alert_candidates.json', 'history',
